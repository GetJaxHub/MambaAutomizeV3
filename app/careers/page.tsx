...
export default function CareersPage() {
  ...
  const jobPositions: JobPosition[] = [
    {
      id: "frontend-developer", // keeping the same ID for consistency
      ...
      description:
        "We're looking for an experienced Full Stack Developer to join our team and help build robust, scalable applications that power our automation solutions.",
      responsibilities: [
        "Design and develop both frontend and backend components of web applications",
        "Build RESTful APIs and integrate with frontend interfaces",
        "Implement responsive UI/UX designs using modern frontend frameworks",
      ...
      requirements: [
        ...
        "Strong proficiency in JavaScript/TypeScript and at least one backend language (Node.js, Python, etc.)",
        "Experience with frontend frameworks like React, Next.js, or Angular",
        "Experience with backend frameworks like Express, NestJS, Django, or Flask",
        "Familiarity with database technologies (SQL and NoSQL)",
        "Understanding of server-side rendering and API optimization techniques",
